...
function bound = expected_search_utility_bound(problem, train_ind, ...
  ...
  if (lookahead == 1)
    ...
    upper_bound = @(num_positives) expected_search_utility_bound(problem, ...
            train_ind, observed_labels, test_ind, probability_bound, ...
            lookahead - 1, num_positives);

    bound = ...
             current_probability_bound  * (1 + upper_bound(num_positives + 1)) + ...
        (1 - current_probability_bound) *      upper_bound(num_positives);
  end
end
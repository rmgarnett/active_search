...
function test_ind = active_search_bound_selector(problem, train_ind, ...
  ...
  p_star_expected_utility = expected_utility_with_lookahead(problem, ...
  ...
  one_fewer_step_optimal_utility = ...
      max(expected_utility_with_lookahead(problem, train_ind, observed_labels, test_ind, ...
          model, expected_utility, selectors, lookahead - 1)) - ...
      search_utility([], [], observed_labels);
